#!/usr/bin/env python3
"""
XLFusion V2.1 - Advanced SDXL checkpoint merger
...
def main() -> int:
    ...
    parser.add_argument("--gui", action="store_true", help="Launch graphical interface (V2.1)")
    ...
    # Interactive mode
    print("\n" + "="*60)
    print(" XLFusion V2.1 - Advanced SDXL checkpoint merger")
    print("="*60)
    print(f"\nDetected structure:")
