...
from .app_modes import analyze_mode, batch_mode, checkpoint_algebra_mode, recovery_mode
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    if args.recover_metadata:
        if args.batch or args.analyze or args.compare or args.recommend or args.algebra:
            ...
            return 1
        return recovery_mode(args, context)

    if args.algebra:
        return checkpoint_algebra_mode(args, context)
    ...
    if args.batch:
        return batch_mode(args, context)
